        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Login Admin:</h6>
                        <a class="collapse-item" href="login.html">Login Super Admin</a>
                        <a class="collapse-item" href="register.html">Login Admin</a>
                        <a class="collapse-item" href="register.html">Login User</a>
                        <a class="collapse-item" href="forgot-password.html">Registerd</a>  
                </div>
            </li>
